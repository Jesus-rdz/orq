...
public interface Constantes {
    /* Errores generales
     */
    public final static String[] PROC_EXITO = {"0", "Procesada la petición."};
    ...
    public final static String[] ERR_CNXDBRUTEO = {"102", "Error: Falló la conexión con la base de ruteo."};
    public final static String[] ERR_NOINFRUTEO = {"103", "Error: No se encontro información en la base de Ruteo."};
    public final static String[] ERR_CNXDB = {"104", "Error: Procesar query y/o intentear conectarse con la base de datos."};
    public final static String[] ERR_ENTRADAINVALIDA = {"105", "Error: Parámetros incompletos en la solicitud."};
